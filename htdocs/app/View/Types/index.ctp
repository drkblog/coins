	...
	<? if ($is_admin) { ?>
 	...
 	<? } ?>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Clone'), array('action' => 'duplicate', $type['Type']['id'])); ?>
			<?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $type['Type']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $type['Type']['id'])); ?>
			<?php echo $this->Html->link(__('Add coin'), array('controller' => 'coins', 'action' => 'add', $type['Type']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List missing types'), array('controller' => 'types', 'action' => 'missing')); ?> </li>
